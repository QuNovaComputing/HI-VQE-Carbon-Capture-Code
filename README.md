...
HI-VQE is also available as the `qunova/hivqe-chemistry` Qiskit Function through the IBM Quantum Platform. The Qiskit Function provides an interface for configuring molecular and HI-VQE calculation parameters and executing HI-VQE calculations on supported quantum computing resources.

Documentation and usage examples are available from the IBM Quantum documentation:
